        ...
        <Box sx={{ display: 'flex' }}>
            ...
            <AppBar
                ...
                <Toolbar sx={myStyles.Toolbar}>
                    ...
                    <Button sx={myStyles.toolbar_button} onClick={handleDialogOpen}>Create New Marvel Character</Button>
                    {/* dialog pop up begins here */}
                    <Dialog open={dialogOpen} onClose={handleDialogClose} aria-labelledby='form-dialog-title'>
                        <DialogTitle id="form-dialog-title">Add new Character</DialogTitle>
                        <DialogContent>
                            <DialogContentText>Enter marvel information below</DialogContentText>
                            <MarvelForm />
                        </DialogContent>
                        <DialogActions>
